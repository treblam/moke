...
var jade_debug = [{ lineno: 1, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" }];
try {
var buf = [];
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (articles, undefined) {
jade_debug.unshift({ lineno: 0, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" });
jade_debug.unshift({ lineno: 1, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" });
// iterate articles
;(function(){
  var $$obj = articles;
...
jade_debug.unshift({ lineno: 1, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" });
jade_debug.unshift({ lineno: 2, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" });
buf.push("<article class=\"article\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 3, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" });
buf.push("<header>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 5, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" });
buf.push("<!-- <div class=\"collection\"><a href=\"#\">月过女墙</a></div>-->");
jade_debug.shift();
jade_debug.unshift({ lineno: 5, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" });
buf.push("<hgroup>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 6, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" });
buf.push("<h3 class=\"title\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 7, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" });
...
buf.push("</h3>");
jade_debug.shift();
jade_debug.unshift({ lineno: 8, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" });
buf.push("<h4 class=\"subtitle\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 9, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" });
buf.push("<a" + (jade.attr("href", '/article/' + (article._id) + '', true, false)) + ">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
...
buf.push("</hgroup>");
jade_debug.shift();
jade_debug.unshift({ lineno: 10, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" });
buf.push("<section class=\"article-info\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 11, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" });
buf.push("<a" + (jade.attr("href", '/home/' + (article.author._id) + '', true, false)) + " class=\"avatar\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 12, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" });
buf.push("<img" + (jade.attr("src", '' + (article.author.avatar_s) + '', true, false)) + " alt=\"作者\"/>");
jade_debug.shift();
jade_debug.shift();
buf.push("</a>");
jade_debug.shift();
jade_debug.unshift({ lineno: 13, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" });
...
buf.push("</a>");
jade_debug.shift();
jade_debug.unshift({ lineno: 14, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" });
if ( article.collection)
{
jade_debug.unshift({ lineno: 15, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" });
jade_debug.unshift({ lineno: 15, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" });
buf.push("发表在");
jade_debug.shift();
jade_debug.unshift({ lineno: 16, filename: "/Users/jamie/Projects/moke/views/cs_share/myreads.jade" });
